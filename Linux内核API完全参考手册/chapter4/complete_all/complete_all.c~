...
int my_function(void * argc)
{
	...
	complete_all(&comple);	//µ÷ÓÃº¯Êý»œÐÑœø³Ì£¬²¢žüžÄdone×Ö¶ÎµÄÖµ					
...
{	
	...
	long left_time;
	wait_queue_t data;
	printk("<0>into complete_all_init.\n");
	...
	printk("<0>the current pid is:%d\n",current->pid);  //ÏÔÊŸµ±Ç°œø³ÌµÄPIDÖµ
	printk("<0>out complete_all_init.\n");
	return 0;
}
