/********************************************************************************
* File Name:	add_wait_queue_exclusive.c
* Description:	第4章实例训练          
...
{	
	...
	printk("<0>into add_wait_queue_exclusive_init.\n");
	...
	printk("<0>out add_wait_queue_exclusive_init.\n");
	return 0;
}
...
{	
        printk("<0>Goodbye add_wait_queue_exclusive\n");	
}
