/********************************************************************************
* File Name:	setup_timer_on_stack_key.c
* Description:	第7章实例训练          
...
int __init timer_init(void)
{
	...
	setup_timer_on_stack_key(&my_timer,"my_timer",NULL,my_timer_function,&my_timer);//调用函数对定时器变量进行初始化
...
{
        printk("<0>Goodbye  setup_timer_on_stack_key\n");
