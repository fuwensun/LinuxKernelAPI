/********************************************************************************
* File Name:	__round_jiffies_relative.c
* Description:	第7章实例训练          
...
int __init __round_jiffies_relative_init(void)
{
	...
	printk("<0>into __round_jiffies_relative_init");
	...
	printk("<0>out __round_jiffies_relative_init");
	return 0;
}

void __exit __round_jiffies_relative_exit(void)
{
        printk("<0>Goodbye __round_jiffies_relative\n");
}
